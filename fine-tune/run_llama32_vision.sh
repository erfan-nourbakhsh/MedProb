...
MODEL_ID="${MODEL_ID:-meta-llama/Llama-3.2-11B-Vision-Instruct}"
MODEL_STEM="${MODEL_STEM:-meta-llama3.2-11b-vision-instruct}"
METHOD="${METHOD:-full}"
GPU_ID="${GPU_ID:-0}"
...
"${PYTHON_BIN}" "${PROJECT_ROOT}/fine-tune/llama32_vision_finetune.py" \
